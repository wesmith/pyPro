...
cv2.createTrackbar('xVal',   camNam, 0, dispW, nothing)
cv2.createTrackbar('yVal',   camNam, 0, dispH, nothing)
cv2.createTrackbar('width',  camNam, 0, dispH, nothing)
cv2.createTrackbar('height', camNam, 0, dispH, nothing)
...
while True:
    ...
    width  = cv2.getTrackbarPos('width',  camNam)
    height = cv2.getTrackbarPos('height', camNam)
    
    cv2.rectangle(frame, (xVal, yVal), (xVal + width, yVal + height), (255, 255, 0), 3)
